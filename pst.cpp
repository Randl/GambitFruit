...
static constexpr std::array<S8, 8> PawnFile = {
	-3, -1, +0, +1, +1, +0, -1, -3,
};

static constexpr std::array<S8, 8> KnightLine = {
	-4, -2, +0, +1, +1, +0, -2, -4,
};

static constexpr std::array<S8, 8> KnightRank = {
	-2, -1, +0, +1, +2, +3, +2, +1,
};

static constexpr std::array<S8, 8> BishopLine = {
	-3, -1, +0, +1, +1, +0, -1, -3,
};

static constexpr std::array<S8, 8> RookFile = {
	-2, -1, +0, +1, +1, +0, -1, -2,
};

static constexpr std::array<S8, 8> QueenLine = {
	-3, -1, +0, +1, +1, +0, -1, -3,
};

static constexpr std::array<S8, 8> KingLine = {
	-3, -1, +0, +1, +1, +0, -1, -3,
};

static constexpr std::array<S8, 8> KingFile = {
	+3, +4, +2, +0, +0, +2, +4, +3,
};

static constexpr std::array<S8, 8> KingRank = {
	+1, +0, -2, -3, -4, -5, -6, -7,
};
